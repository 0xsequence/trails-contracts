...
contract TrailsLiFiInterpreterTest is Test {
    ...
    function test_GetOriginSwapInfo_WithSourceSwaps() public {
        ...
        TrailsExecutionInfo memory result = TrailsLiFiInterpreter.getOriginSwapInfo(mockBridgeData, mockSwapDataArray);
    ...
    //     vm.expectRevert();
    //     TrailsLiFiInterpreter.getOriginSwapInfo(mockBridgeData, mockSwapDataArray);
    // }
