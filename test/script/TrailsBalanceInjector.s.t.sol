...
import {Deploy as TrailsBalanceInjectorDeploy} from "script/TrailsBalanceInjector.s.sol";
import {TrailsBalanceInjector} from "src/TrailsBalanceInjector.sol";

contract TrailsBalanceInjectorDeploymentTest is Test {
    TrailsBalanceInjectorDeploy internal deployScript;
    address internal deployer;
    uint256 internal deployerPk;
    string internal deployerPkStr;

    function setUp() public {
        deployScript = new TrailsBalanceInjectorDeploy();
    ...
    function test_DeployBalanceInjector_Success() public {
    ...
    function test_DeployBalanceInjector_SameAddress() public {
        vm.setEnv("PRIVATE_KEY", deployerPkStr);
    ...
    function test_DeployedContract_HasCorrectConfiguration() public {
        ...
        // 2. Verify the contract is configured correctly
