...
import {Deploy as TrailsTokenSweeperDeploy} from "script/TrailsTokenSweeper.s.sol";
import {TrailsTokenSweeper} from "src/TrailsTokenSweeper.sol";

contract TrailsTokenSweeperDeploymentTest is Test {
    TrailsTokenSweeperDeploy internal deployScript;
    address internal deployer;
    uint256 internal deployerPk;
    string internal deployerPkStr;

    function setUp() public {
        deployScript = new TrailsTokenSweeperDeploy();
    ...
    function test_DeployTokenSweeper_Success() public {
    ...
    function test_DeployTokenSweeper_SameAddress() public {
        vm.setEnv("PRIVATE_KEY", deployerPkStr);
